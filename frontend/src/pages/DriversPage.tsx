...
const drivers2026: Driver[] = [
    ...
    { number: 87, firstName: 'OLLIE', lastName: 'BEARMAN', team: 'HAAS F1 TEAM', teamColor: 'B6BABD', country: 'GBR' },
    { number: 31, firstName: 'ESTEBAN', lastName: 'OCON', team: 'HAAS F1 TEAM', teamColor: 'B6BABD', country: 'FRA' },
    { number: 23, firstName: 'ALEX', lastName: 'ALBON', team: 'WILLIAMS', teamColor: '64C4FF', country: 'THA' },
    ...
    { number: 40, firstName: 'ARVID', lastName: 'LINDBLAD', team: 'RACING BULLS', teamColor: '6692FF', country: 'GBR' },
    { number: 27, firstName: 'NICO', lastName: 'HULKENBERG', team: 'AUDI', teamColor: '000000', country: 'GER' },
    { number: 5, firstName: 'GABRIEL', lastName: 'BORTOLETO', team: 'AUDI', teamColor: '000000', country: 'BRA' },
    { number: 77, firstName: 'VALTTERI', lastName: 'BOTTAS', team: 'CADILLAC', teamColor: '000000', country: 'FIN' },
    { number: 11, firstName: 'SERGIO', lastName: 'PEREZ', team: 'CADILLAC', teamColor: '000000', country: 'MEX' },
];
